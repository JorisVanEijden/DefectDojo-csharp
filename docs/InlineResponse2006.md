# DefectDojo.Model.InlineResponse2006
## Properties
...
**AcceptedRisks** | [**List&lt;RiskAcceptance&gt;**](RiskAcceptance.md) |  | [optional] 
**PushToJira** | **bool?** |  | [optional] [default to false]
**Age** | **int?** |  | [optional] 
**SlaDaysRemaining** | **int?** |  | [optional] 
**FindingMeta** | [**List&lt;FindingMeta&gt;**](FindingMeta.md) |  | [optional] 
**RelatedFields** | [**FindingRelatedFields**](FindingRelatedFields.md) |  | [optional] 
**JiraCreation** | **DateTime?** |  | [optional] 
**JiraChange** | **DateTime?** |  | [optional] 
**DisplayStatus** | **List&lt;string&gt;** |  | [optional] 
...
**Url** | **string** | External reference that provides more information about this flaw. | [optional] 

...
namespace DefectDojo.Model
{
    ...
    public partial class InlineResponse20017 :  IEquatable<InlineResponse20017>
    {
        ...
        public InlineResponse20017(int? count = default(int?), string next = default(string), string previous = default(string), List<Regulation> results = default(List<Regulation>))
        {
            // to ensure "count" is required (not null)
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for InlineResponse20017 and cannot be null");
            }
            else
            {
                this.Count = count;
            ...
            if (results == null)
            {
                throw new InvalidDataException("results is a required property for InlineResponse20017 and cannot be null");
            }
            else
            {
        ...
        public List<Regulation> Results { get; set; }

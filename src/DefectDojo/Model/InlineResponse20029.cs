...
namespace DefectDojo.Model
{
    ...
    public partial class InlineResponse20029 :  IEquatable<InlineResponse20029>
    {
        ...
        public InlineResponse20029(int? count = default(int?), string next = default(string), string previous = default(string), List<ToolProductSettings> results = default(List<ToolProductSettings>))
        {
            // to ensure "count" is required (not null)
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for InlineResponse20029 and cannot be null");
            }
            else
            {
                this.Count = count;
            ...
            if (results == null)
            {
                throw new InvalidDataException("results is a required property for InlineResponse20029 and cannot be null");
            }
            else
            {
        ...
        public List<ToolProductSettings> Results { get; set; }

...
namespace DefectDojo.Model
{
    ...
    public partial class InlineResponse2006 :  IEquatable<InlineResponse2006>
    {
        ...
        /// <param name="relatedFields">relatedFields.</param>
        ...
        public InlineResponse2006(List<string> tags = default(List<string>), bool? pushToJira = false, FindingRelatedFields relatedFields = default(FindingRelatedFields), string title = default(string), DateTime? date = default(DateTime?), DateTime? slaStartDate = default(DateTime?), int? cwe = default(int?), string cve = default(string), string cvssv3 = default(string), decimal? cvssv3Score = default(decimal?), string severity = default(string), string description = default(string), string mitigation = default(string), string impact = default(string), string stepsToReproduce = default(string), string severityJustification = default(string), string references = default(string), bool? isTemplate = default(bool?), bool? active = default(bool?), bool? verified = default(bool?), bool? falseP = default(bool?), bool? duplicate = default(bool?), bool? outOfScope = default(bool?), bool? riskAccepted = default(bool?), bool? underReview = default(bool?), bool? underDefectReview = default(bool?), bool? isMitigated = default(bool?), string numericalSeverity = default(string), int? line = default(int?), string filePath = default(string), string componentName = default(string), string componentVersion = default(string), bool? staticFinding = default(bool?), bool? dynamicFinding = default(bool?), string uniqueIdFromTool = default(string), string vulnIdFromTool = default(string), string sastSourceObject = default(string), string sastSinkObject = default(string), int? sastSourceLine = default(int?), string sastSourceFilePath = default(string), int? nbOccurences = default(int?), DateTime? publishDate = default(DateTime?), int? reviewRequestedBy = default(int?), int? defectReviewRequestedBy = default(int?), int? sonarqubeIssue = default(int?), List<int?> endpoints = default(List<int?>), List<int?> endpointStatus = default(List<int?>), List<int?> reviewers = default(List<int?>), InlineResponse2005Prefetch prefetch = default(InlineResponse2005Prefetch))
        {
            ...
            if (severity == null)
            {
                throw new InvalidDataException("severity is a required property for InlineResponse2006 and cannot be null");
            }
            else
            {
            ...
            if (description == null)
            {
                throw new InvalidDataException("description is a required property for InlineResponse2006 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("numericalSeverity is a required property for InlineResponse2006 and cannot be null");
            }
            else
            {
        ...
        public List<FindingImage> Images { get; private set; }
        ...
        /// <summary>
        /// Gets or Sets RequestResponse
        /// </summary>
        [DataMember(Name="request_response", EmitDefaultValue=false)]
        public string RequestResponse { get; private set; }

        /// <summary>
        /// Gets or Sets AcceptedRisks
        /// </summary>
        [DataMember(Name="accepted_risks", EmitDefaultValue=false)]
        public List<RiskAcceptance> AcceptedRisks { get; private set; }
        ...
        /// <summary>
        /// Gets or Sets SlaDaysRemaining
        /// </summary>
        [DataMember(Name="sla_days_remaining", EmitDefaultValue=false)]
        public int? SlaDaysRemaining { get; private set; }

        /// <summary>
        /// Gets or Sets FindingMeta
        /// </summary>
        [DataMember(Name="finding_meta", EmitDefaultValue=false)]
        public List<FindingMeta> FindingMeta { get; private set; }

        /// <summary>
        /// Gets or Sets RelatedFields
        /// </summary>
        [DataMember(Name="related_fields", EmitDefaultValue=false)]
        public FindingRelatedFields RelatedFields { get; set; }

        /// <summary>
        /// Gets or Sets JiraCreation
        /// </summary>
        [DataMember(Name="jira_creation", EmitDefaultValue=false)]
        public DateTime? JiraCreation { get; private set; }

        /// <summary>
        /// Gets or Sets JiraChange
        /// </summary>
        [DataMember(Name="jira_change", EmitDefaultValue=false)]
        public DateTime? JiraChange { get; private set; }

        /// <summary>
        /// Gets or Sets DisplayStatus
        /// </summary>
        [DataMember(Name="display_status", EmitDefaultValue=false)]
        public List<string> DisplayStatus { get; private set; }
        ...
        /// </summary>
        /// <value>External reference that provides more information about this flaw.</value>
        ...
        /// </summary>
        /// <value>The test that is associated with this flaw.</value>
        ...
        /// </summary>
        /// <value>The name of the scanner that identified the flaw.</value>
        [DataMember(Name="found_by", EmitDefaultValue=false)]
        public List<int?> FoundBy { get; private set; }

        /// <summary>
        /// Gets or Sets Prefetch
        /// </summary>
        [DataMember(Name="prefetch", EmitDefaultValue=false)]
        public InlineResponse2005Prefetch Prefetch { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AcceptedRisks: ").Append(AcceptedRisks).Append("\n");
            sb.Append("  PushToJira: ").Append(PushToJira).Append("\n");
            sb.Append("  Age: ").Append(Age).Append("\n");
            sb.Append("  SlaDaysRemaining: ").Append(SlaDaysRemaining).Append("\n");
            sb.Append("  FindingMeta: ").Append(FindingMeta).Append("\n");
            sb.Append("  RelatedFields: ").Append(RelatedFields).Append("\n");
        ...
        public bool Equals(InlineResponse2006 input)
        {
            ...
            return 
                ...
                (
                    this.AcceptedRisks == input.AcceptedRisks ||
                    this.AcceptedRisks != null &&
                    this.AcceptedRisks.SequenceEqual(input.AcceptedRisks)
                ) && 
                (
                ...
                (
                    this.SlaDaysRemaining == input.SlaDaysRemaining ||
                    (this.SlaDaysRemaining != null &&
                    this.SlaDaysRemaining.Equals(input.SlaDaysRemaining))
                ) && 
                (
                    this.FindingMeta == input.FindingMeta ||
                    this.FindingMeta != null &&
                    this.FindingMeta.SequenceEqual(input.FindingMeta)
                ) && 
                (
                    this.RelatedFields == input.RelatedFields ||
                    (this.RelatedFields != null &&
                    this.RelatedFields.Equals(input.RelatedFields))
                ) && 
                (
                ...
                (
                    ...
                    this.DisplayStatus.SequenceEqual(input.DisplayStatus)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AcceptedRisks != null)
                    hashCode = hashCode * 59 + this.AcceptedRisks.GetHashCode();
                if (this.PushToJira != null)
                    hashCode = hashCode * 59 + this.PushToJira.GetHashCode();
                if (this.Age != null)
                    hashCode = hashCode * 59 + this.Age.GetHashCode();
                if (this.SlaDaysRemaining != null)
                    hashCode = hashCode * 59 + this.SlaDaysRemaining.GetHashCode();
                if (this.FindingMeta != null)
                    hashCode = hashCode * 59 + this.FindingMeta.GetHashCode();
                if (this.RelatedFields != null)
                    hashCode = hashCode * 59 + this.RelatedFields.GetHashCode();

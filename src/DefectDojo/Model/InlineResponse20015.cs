...
namespace DefectDojo.Model
{
    ...
    public partial class InlineResponse20015 :  IEquatable<InlineResponse20015>
    {
        ...
        public InlineResponse20015(int? count = default(int?), string next = default(string), string previous = default(string), List<Product> results = default(List<Product>), InlineResponse20015Prefetch prefetch = default(InlineResponse20015Prefetch))
        {
            // to ensure "count" is required (not null)
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for InlineResponse20015 and cannot be null");
            }
            else
            {
                this.Count = count;
            ...
            if (results == null)
            {
                throw new InvalidDataException("results is a required property for InlineResponse20015 and cannot be null");
            }
            else
            {

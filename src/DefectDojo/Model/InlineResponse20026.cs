...
namespace DefectDojo.Model
{
    ...
    public partial class InlineResponse20026 :  IEquatable<InlineResponse20026>
    {
        ...
        public InlineResponse20026(int? count = default(int?), string next = default(string), string previous = default(string), List<TestType> results = default(List<TestType>))
        {
            // to ensure "count" is required (not null)
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for InlineResponse20026 and cannot be null");
            }
            else
            {
                this.Count = count;
            ...
            if (results == null)
            {
                throw new InvalidDataException("results is a required property for InlineResponse20026 and cannot be null");
            }
            else
            {
        ...
        public List<TestType> Results { get; set; }

...
namespace DefectDojo.Model
{
    ...
    public partial class InlineResponse2005 :  IEquatable<InlineResponse2005>
    {
        ...
        public InlineResponse2005(int? count = default(int?), string next = default(string), string previous = default(string), List<Finding> results = default(List<Finding>), InlineResponse2005Prefetch prefetch = default(InlineResponse2005Prefetch))
        {

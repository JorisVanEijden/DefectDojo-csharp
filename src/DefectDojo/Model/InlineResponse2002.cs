...
namespace DefectDojo.Model
{
    ...
    public partial class InlineResponse2002 :  IEquatable<InlineResponse2002>
    {
        ...
        public InlineResponse2002(int? count = default(int?), string next = default(string), string previous = default(string), List<Endpoint> results = default(List<Endpoint>))
        {
        ...
        public List<Endpoint> Results { get; set; }

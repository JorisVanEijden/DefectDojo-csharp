...
namespace DefectDojo.Model
{
    ...
    public partial class InlineResponse2004 :  IEquatable<InlineResponse2004>
    {
        ...
        public InlineResponse2004(int? count = default(int?), string next = default(string), string previous = default(string), List<FindingTemplate> results = default(List<FindingTemplate>))
        {
        ...
        public List<FindingTemplate> Results { get; set; }

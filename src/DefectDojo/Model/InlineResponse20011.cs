...
namespace DefectDojo.Model
{
    ...
    public partial class InlineResponse20011 :  IEquatable<InlineResponse20011>
    {
        ...
        public InlineResponse20011(int? count = default(int?), string next = default(string), string previous = default(string), List<NoteType> results = default(List<NoteType>))
        {
        ...
        public List<NoteType> Results { get; set; }

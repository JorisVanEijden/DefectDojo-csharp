...
namespace DefectDojo.Model
{
    ...
    public partial class InlineResponse2001 :  IEquatable<InlineResponse2001>
    {
        ...
        public InlineResponse2001(int? count = default(int?), string next = default(string), string previous = default(string), List<EndpointStatus> results = default(List<EndpointStatus>))
        {
        ...
        public List<EndpointStatus> Results { get; set; }

...
namespace DefectDojo.Model
{
    ...
    public partial class InlineResponse20031 :  IEquatable<InlineResponse20031>
    {
        ...
        public InlineResponse20031(int? count = default(int?), string next = default(string), string previous = default(string), List<User> results = default(List<User>))
        {
            // to ensure "count" is required (not null)
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for InlineResponse20031 and cannot be null");
            }
            else
            {
                this.Count = count;
            ...
            if (results == null)
            {
                throw new InvalidDataException("results is a required property for InlineResponse20031 and cannot be null");
            }
            else
            {

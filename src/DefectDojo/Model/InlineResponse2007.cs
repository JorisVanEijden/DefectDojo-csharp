...
namespace DefectDojo.Model
{
    ...
    public partial class InlineResponse2007 :  IEquatable<InlineResponse2007>
    {
        ...
        public InlineResponse2007(int? count = default(int?), string next = default(string), string previous = default(string), List<JIRAInstance> results = default(List<JIRAInstance>))
        {
        ...
        public List<JIRAInstance> Results { get; set; }

...
namespace DefectDojo.Model
{
    ...
    public partial class InlineResponse200 :  IEquatable<InlineResponse200>
    {
        ...
        public InlineResponse200(int? count = default(int?), string next = default(string), string previous = default(string), List<DevelopmentEnvironment> results = default(List<DevelopmentEnvironment>))
        {
        ...
        public List<DevelopmentEnvironment> Results { get; set; }

...
namespace DefectDojo.Model
{
    ...
    public partial class InlineResponse20030 :  IEquatable<InlineResponse20030>
    {
        ...
        public InlineResponse20030(int? count = default(int?), string next = default(string), string previous = default(string), List<ToolType> results = default(List<ToolType>))
        {
            // to ensure "count" is required (not null)
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for InlineResponse20030 and cannot be null");
            }
            else
            {
                this.Count = count;
            ...
            if (results == null)
            {
                throw new InvalidDataException("results is a required property for InlineResponse20030 and cannot be null");
            }
            else
            {
        ...
        public List<ToolType> Results { get; set; }

...
namespace DefectDojo.Model
{
    ...
    public partial class InlineResponse2008 :  IEquatable<InlineResponse2008>
    {
        ...
        public InlineResponse2008(int? count = default(int?), string next = default(string), string previous = default(string), List<JIRAIssue> results = default(List<JIRAIssue>))
        {

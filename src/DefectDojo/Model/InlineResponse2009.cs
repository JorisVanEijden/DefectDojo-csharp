...
namespace DefectDojo.Model
{
    ...
    public partial class InlineResponse2009 :  IEquatable<InlineResponse2009>
    {
        ...
        public InlineResponse2009(int? count = default(int?), string next = default(string), string previous = default(string), List<JIRAProject> results = default(List<JIRAProject>))
        {
        ...
        public List<JIRAProject> Results { get; set; }

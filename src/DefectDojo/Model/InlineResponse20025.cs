...
namespace DefectDojo.Model
{
    ...
    public partial class InlineResponse20025 :  IEquatable<InlineResponse20025>
    {
        ...
        public InlineResponse20025(string importSettings = default(string), string type = default(string), string version = default(string), string buildId = default(string), string commitHash = default(string), string branchTag = default(string), InlineResponse20024Prefetch prefetch = default(InlineResponse20024Prefetch))
        {

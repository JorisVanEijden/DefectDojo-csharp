...
namespace DefectDojo.Model
{
    ...
    public partial class InlineResponse20028 :  IEquatable<InlineResponse20028>
    {
        ...
        public InlineResponse20028(int? count = default(int?), string next = default(string), string previous = default(string), List<ToolConfiguration> results = default(List<ToolConfiguration>))
        {
            // to ensure "count" is required (not null)
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for InlineResponse20028 and cannot be null");
            }
            else
            {
                this.Count = count;
            ...
            if (results == null)
            {
                throw new InvalidDataException("results is a required property for InlineResponse20028 and cannot be null");
            }
            else
            {
        ...
        public List<ToolConfiguration> Results { get; set; }

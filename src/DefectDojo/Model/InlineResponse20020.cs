...
namespace DefectDojo.Model
{
    ...
    public partial class InlineResponse20020 :  IEquatable<InlineResponse20020>
    {
        ...
        public InlineResponse20020(int? count = default(int?), string next = default(string), string previous = default(string), List<SonarqubeIssueTransition> results = default(List<SonarqubeIssueTransition>))
        {
            // to ensure "count" is required (not null)
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for InlineResponse20020 and cannot be null");
            }
            else
            {
                this.Count = count;
            ...
            if (results == null)
            {
                throw new InvalidDataException("results is a required property for InlineResponse20020 and cannot be null");
            }
            else
            {
        ...
        public List<SonarqubeIssueTransition> Results { get; set; }

...
namespace DefectDojo.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ImportScan :  IEquatable<ImportScan>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ImportScan" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ImportScan() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ImportScan" /> class.
        /// </summary>
        ...
        /// <param name="engagement">engagement (required).</param>
        /// <param name="lead">lead.</param>
        /// <param name="tags">tags.</param>
        /// <param name="closeOldFindings">closeOldFindings (default to false).</param>
        ...
        public ImportScan(DateTime? scanDate = default(DateTime?), MinimumSeverityEnum? minimumSeverity = MinimumSeverityEnum.Info, bool? active = true, bool? verified = true, ScanTypeEnum scanType = default(ScanTypeEnum), int? endpointToAdd = default(int?), int? engagement = default(int?), int? lead = default(int?), List<string> tags = default(List<string>), bool? closeOldFindings = false, bool? pushToJira = false, string environment = default(string), string version = default(string), string buildId = default(string), string branchTag = default(string), string commitHash = default(string))
        {
            // to ensure "scanType" is required (not null)
            if (scanType == null)
            {
                throw new InvalidDataException("scanType is a required property for ImportScan and cannot be null");
            }
            else
            {
                this.ScanType = scanType;
            }
            // to ensure "engagement" is required (not null)
            if (engagement == null)
            {
                throw new InvalidDataException("engagement is a required property for ImportScan and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as ImportScan);
        }

        /// <summary>
        /// Returns true if ImportScan instances are equal
        /// </summary>
        /// <param name="input">Instance of ImportScan to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ImportScan input)
        {
            if (input == null)
                return false;

...
namespace DefectDojo.Model
{
    ...
    public partial class InlineResponse20013 :  IEquatable<InlineResponse20013>
    {
        ...
        public InlineResponse20013(int? count = default(int?), string next = default(string), string previous = default(string), List<ProductType> results = default(List<ProductType>), InlineResponse20013Prefetch prefetch = default(InlineResponse20013Prefetch))
        {

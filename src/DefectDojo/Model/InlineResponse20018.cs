...
namespace DefectDojo.Model
{
    ...
    public partial class InlineResponse20018 :  IEquatable<InlineResponse20018>
    {
        ...
        public InlineResponse20018(int? count = default(int?), string next = default(string), string previous = default(string), List<SonarqubeIssue> results = default(List<SonarqubeIssue>))
        {
            // to ensure "count" is required (not null)
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for InlineResponse20018 and cannot be null");
            }
            else
            {
                this.Count = count;
            ...
            if (results == null)
            {
                throw new InvalidDataException("results is a required property for InlineResponse20018 and cannot be null");
            }
            else
            {
        ...
        public List<SonarqubeIssue> Results { get; set; }

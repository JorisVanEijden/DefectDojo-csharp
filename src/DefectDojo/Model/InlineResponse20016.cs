...
namespace DefectDojo.Model
{
    ...
    public partial class InlineResponse20016 :  IEquatable<InlineResponse20016>
    {
        ...
        public InlineResponse20016(List<string> tags = default(List<string>), string name = default(string), string description = default(string), int? prodNumericGrade = default(int?), BusinessCriticalityEnum? businessCriticality = default(BusinessCriticalityEnum?), PlatformEnum? platform = default(PlatformEnum?), LifecycleEnum? lifecycle = default(LifecycleEnum?), OriginEnum? origin = default(OriginEnum?), int? userRecords = default(int?), string revenue = default(string), bool? externalAudience = default(bool?), bool? internetAccessible = default(bool?), bool? enableSimpleRiskAcceptance = default(bool?), bool? enableFullRiskAcceptance = default(bool?), int? productManager = default(int?), int? technicalContact = default(int?), int? teamManager = default(int?), int? prodType = default(int?), List<int?> authorizedUsers = default(List<int?>), List<int?> regulations = default(List<int?>), InlineResponse20015Prefetch prefetch = default(InlineResponse20015Prefetch))
        {
            ...
            if (prodType == null)
            {
                throw new InvalidDataException("prodType is a required property for InlineResponse20016 and cannot be null");
            }
            else
            {
        ...
        public InlineResponse20015Prefetch Prefetch { get; set; }

...
namespace DefectDojo.Model
{
    ...
    public partial class InlineResponse20010 :  IEquatable<InlineResponse20010>
    {
        ...
        public InlineResponse20010(int? count = default(int?), string next = default(string), string previous = default(string), List<Meta> results = default(List<Meta>))
        {
        ...
        public List<Meta> Results { get; set; }

...
namespace DefectDojo.Model
{
    ...
    public partial class InlineResponse20027 :  IEquatable<InlineResponse20027>
    {
        ...
        public InlineResponse20027(int? count = default(int?), string next = default(string), string previous = default(string), List<Test> results = default(List<Test>))
        {
            // to ensure "count" is required (not null)
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for InlineResponse20027 and cannot be null");
            }
            else
            {
                this.Count = count;
            ...
            if (results == null)
            {
                throw new InvalidDataException("results is a required property for InlineResponse20027 and cannot be null");
            }
            else
            {

...
namespace DefectDojo.Model
{
    ...
    public partial class InlineResponse20022 :  IEquatable<InlineResponse20022>
    {
        ...
        public InlineResponse20022(int? count = default(int?), string next = default(string), string previous = default(string), List<SystemSettings> results = default(List<SystemSettings>))
        {
            // to ensure "count" is required (not null)
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for InlineResponse20022 and cannot be null");
            }
            else
            {
                this.Count = count;
            ...
            if (results == null)
            {
                throw new InvalidDataException("results is a required property for InlineResponse20022 and cannot be null");
            }
            else
            {
        ...
        public List<SystemSettings> Results { get; set; }

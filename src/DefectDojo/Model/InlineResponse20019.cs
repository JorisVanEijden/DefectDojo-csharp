...
namespace DefectDojo.Model
{
    ...
    public partial class InlineResponse20019 :  IEquatable<InlineResponse20019>
    {
        ...
        public InlineResponse20019(int? count = default(int?), string next = default(string), string previous = default(string), List<SonarqubeProduct> results = default(List<SonarqubeProduct>))
        {
            // to ensure "count" is required (not null)
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for InlineResponse20019 and cannot be null");
            }
            else
            {
                this.Count = count;
            ...
            if (results == null)
            {
                throw new InvalidDataException("results is a required property for InlineResponse20019 and cannot be null");
            }
            else
            {
        ...
        public List<SonarqubeProduct> Results { get; set; }

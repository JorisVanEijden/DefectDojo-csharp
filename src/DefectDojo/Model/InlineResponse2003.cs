...
namespace DefectDojo.Model
{
    ...
    public partial class InlineResponse2003 :  IEquatable<InlineResponse2003>
    {
        ...
        public InlineResponse2003(int? count = default(int?), string next = default(string), string previous = default(string), List<Engagement> results = default(List<Engagement>))
        {

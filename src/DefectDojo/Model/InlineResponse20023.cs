...
namespace DefectDojo.Model
{
    ...
    public partial class InlineResponse20023 :  IEquatable<InlineResponse20023>
    {
        ...
        public InlineResponse20023(int? count = default(int?), string next = default(string), string previous = default(string), List<AppAnalysis> results = default(List<AppAnalysis>))
        {
            // to ensure "count" is required (not null)
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for InlineResponse20023 and cannot be null");
            }
            else
            {
                this.Count = count;
            ...
            if (results == null)
            {
                throw new InvalidDataException("results is a required property for InlineResponse20023 and cannot be null");
            }
            else
            {
        ...
        public List<AppAnalysis> Results { get; set; }

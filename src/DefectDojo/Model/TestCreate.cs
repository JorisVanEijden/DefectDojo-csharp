...
namespace DefectDojo.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TestCreate :  IEquatable<TestCreate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TestCreate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TestCreate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TestCreate" /> class.
        /// </summary>
        ...
        public TestCreate(int? engagement = default(int?), List<int?> notes = default(List<int?>), List<string> tags = default(List<string>), string title = default(string), string description = default(string), DateTime? targetStart = default(DateTime?), DateTime? targetEnd = default(DateTime?), int? percentComplete = default(int?), string version = default(string), string buildId = default(string), string commitHash = default(string), string branchTag = default(string), int? lead = default(int?), int? testType = default(int?), int? environment = default(int?))
        {
            ...
            if (targetStart == null)
            {
                throw new InvalidDataException("targetStart is a required property for TestCreate and cannot be null");
            }
            else
            {
            ...
            if (targetEnd == null)
            {
                throw new InvalidDataException("targetEnd is a required property for TestCreate and cannot be null");
            }
            else
            {
            ...
            if (testType == null)
            {
                throw new InvalidDataException("testType is a required property for TestCreate and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as TestCreate);
        }

        /// <summary>
        /// Returns true if TestCreate instances are equal
        /// </summary>
        /// <param name="input">Instance of TestCreate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TestCreate input)
        {
            if (input == null)
                return false;

...
namespace DefectDojo.Api
{
    ...
    /// </summary>
    public interface IImportScanApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class ImportScanApi : IImportScanApi
    {
        private DefectDojo.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="ImportScanApi"/> class.
        /// </summary>
        /// <returns></returns>
        public ImportScanApi(String basePath)
        {
        ...
        /// <returns></returns>
        public ImportScanApi(DefectDojo.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse< ImportScan > ImportScanCreateWithHttpInfo (string scanType, int? engagement, DateTime? scanDate = null, string minimumSeverity = null, bool? active = null, bool? verified = null, int? endpointToAdd = null, System.IO.Stream file = null, int? lead = null, List<string> tags = null, bool? closeOldFindings = null, bool? pushToJira = null, string environment = null, string version = null, string buildId = null, string branchTag = null, string commitHash = null)
        {
            ...
            if (scanType == null)
                throw new ApiException(400, "Missing required parameter 'scanType' when calling ImportScanApi->ImportScanCreate");
            // verify the required parameter 'engagement' is set
            if (engagement == null)
                throw new ApiException(400, "Missing required parameter 'engagement' when calling ImportScanApi->ImportScanCreate");

            var localVarPath = "./import-scan/";
            ...
            if (environment != null) localVarFormParams.Add("environment", this.Configuration.ApiClient.ParameterToString(environment)); // form parameter
            ...
            {
                Exception exception = ExceptionFactory("ImportScanCreate", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<ImportScan>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Key, x => x.Value.ToString()),
                (ImportScan) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(ImportScan)));
        }
